...
<div class="main2" bind:this={main2}>
    <div>
    <h1>The Rundown:</h1>
    <p><strong>Epoch VT</strong> is a 10-hour hackathon (social coding event) where teens will come together to discover the joy of code, build creative projects, learn new skills, and build connections with one another. <br><br>It's taking place at <strong><a href="https://goo.gl/maps/6GnAJgtejh7qqH726">Hack Club HQ</a></strong> (15 Falls Road, Shelburne) from 10AM to 8PM on December 30, 2022. Whether you've never coded before or you're a seasoned developer, we'd love to have you join us!
