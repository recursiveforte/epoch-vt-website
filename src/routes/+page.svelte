...
<div class="main2" bind:this={main2}>
    ...
    <h1>The Rundown:</h1>
        ...
        <br><br>It's one of many regional events surrounding <a href="https://epoch.hackclub.com">Epoch</a>, a large high-school hackathon taking place in Delhi, India, which is organized by <a href="https://hackclub.com">Hack Club</a>.
        <br><br>Everything at this event is totally free, including lunch, dinner, swag (hoodies & stickers!), and other goodies. Our finances are all publicly visible on <a href="https://bank.hackclub.com/epochvt">Hack Club Bank</a>.
