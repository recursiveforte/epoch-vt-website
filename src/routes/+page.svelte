...
<div class="main" style="overflow: hidden">
    ...
    <div class="quick-info">
        <h2 style="text-align: center; font-size: 1.4em"><strong><FontAwesomeIcon icon={faMapLocationDot} /></strong> <a href="https://goo.gl/maps/Gcg2WaMsEULbKxK46">Hack Club HQ</a>, Shelburne VT &nbsp;&nbsp;<strong>|</strong>
...
<div class="main2" bind:this={main2}>
    <div class="quick-info mobile-only">
        <h2 style="text-align: center"><strong><FontAwesomeIcon icon={faMapLocationDot} /></strong> <a href="https://goo.gl/maps/Gcg2WaMsEULbKxK46">Hack Club HQ</a>, Shelburne VT<br>
