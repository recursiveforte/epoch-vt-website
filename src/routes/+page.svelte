...
<div class="main" style="overflow: hidden">
    <div class="content" style="color: white">
        <h1 style="margin: 0; font-family: 'JetBrains Mono', monospace; ">Join other high <br>schoolers on <br><strong>December 30</strong> <br>
            for 10 hours of <br><strong>fun & making</strong> at <br>
           </h1> <img src="/epoch%20logo-2.png" style="margin: 3px 0 6px -10px; width: 200px" alt="Epoch VT"/>
        <h3 style="margin: 0;">(register below)</h3>
